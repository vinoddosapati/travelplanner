...
const config = new angularx_social_login__WEBPACK_IMPORTED_MODULE_15__["AuthServiceConfig"]([
    {
...
let BookedpackageComponent = class BookedpackageComponent {
...
BookedpackageComponent.ctorParameters = () => [
...
let CreatePackageComponent = class CreatePackageComponent {
    ...
    constructor(router, dataservice, flightService, hotelService) {
        this.router = router;
        this.dataservice = dataservice;
    ...
    viewFlights(sourceairport, destairport, travelDate) {
    ...
    viewReturnFlights(sourceairport, destairport, travelDate) {
        this.flightService.getSkyScannerFlights(sourceairport, destairport, travelDate).subscribe(flights => {
    ...
    returnflightDetailsModify(flightBooked) {
    ...
    flightDetailsModify(flightBooked) {
        console.log('carries' + flightBooked.OutboundLeg.CarrierIds[0]);
        // tslint:disable-next-line: prefer-for-of
        for (let i = 0; i < flightBooked.OutboundLeg.CarrierIds.length; i++) {
...
let CreatespecialholidayComponent = class CreatespecialholidayComponent {
    constructor(router, dataservice) {
        this.router = router;
        this.dataservice = dataservice;
    }
...
CreatespecialholidayComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _dataintegrate_service__WEBPACK_IMPORTED_MODULE_3__["DataintegrateService"] }
];
...
let DataintegrateService = class DataintegrateService {
    // tslint:disable-next-line: variable-name
    ...
    // }
    addspecialPackage(specialholiday) {
...
DataintegrateService.ctorParameters = () => [
...
let FlightsService = class FlightsService {
    ...
    getSkyScannerFlights(sourceairport, destairport, traveldate) {
    ...
    getAirportsList(paramatersAirport) {
...
let MenudropComponent = class MenudropComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
PackageComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _dataintegrate_service__WEBPACK_IMPORTED_MODULE_2__["DataintegrateService"] }
];
...
let SpecialholidayviewComponent = class SpecialholidayviewComponent {
    constructor(router, dataservice) {
        this.router = router;
        this.dataservice = dataservice;
    }
...
SpecialholidayviewComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _dataintegrate_service__WEBPACK_IMPORTED_MODULE_3__["DataintegrateService"] }
];
...
let UserPacketCreateComponent = class UserPacketCreateComponent {
    // tslint:disable-next-line: max-line-length
    constructor(router, dataservice, flightService, hotelService) {
        this.router = router;
        this.dataservice = dataservice;
...
UserPacketCreateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _dataintegrate_service__WEBPACK_IMPORTED_MODULE_3__["DataintegrateService"] },
    { type: _flights_service__WEBPACK_IMPORTED_MODULE_4__["FlightsService"] },
    { type: _hotels_service__WEBPACK_IMPORTED_MODULE_5__["HotelsService"] }
...
let ViewCreatedPackageComponent = class ViewCreatedPackageComponent {
    constructor(router, dataservice) {
        this.router = router;
        this.dataservice = dataservice;
    }
...
ViewCreatedPackageComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _dataintegrate_service__WEBPACK_IMPORTED_MODULE_3__["DataintegrateService"] }
];
...
let ViewtripComponent = class ViewtripComponent {
    constructor(router, dataservice) {
        this.router = router;
        this.dataservice = dataservice;
    }
...
ViewtripComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _dataintegrate_service__WEBPACK_IMPORTED_MODULE_3__["DataintegrateService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
